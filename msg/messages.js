...
Blockly.Msg.LT_CATEGORY_STATUS = "Status";
Blockly.Msg.LT_CATEGORY_LOGIC = "Logic";
Blockly.Msg.LT_EVENT_ON_DEVICE_TITLE = "Device type: %1%4Event on: %2%5Event type: %3";
Blockly.Msg.LT_EVENT_ON_DEVICE_DO_ACTIONS = "do actions %1";
Blockly.Msg.LT_EVENT_ON_DEVICE_TT = "Event on device.";
...
Blockly.Msg.TEXT_SPRINTF_TOOLTIP = "sprintf function";
Blockly.Msg.TEXT_SPRINTF_MUTATOR = "Mutation";
Blockly.Msg.TEXT_SPRINTF_ONOFF = "On/Off";
Blockly.Msg.LT_CATEGORY_LOGIC = "Logic";
...
Blockly.Msg.TEXT_SPRINTF_SENS = "Sensor:";
Blockly.Msg.TEXT_SPRINTF_DIMMER = "Dimmer-lamp:";
Blockly.Msg.TEXT_SPRINTF_RGB = "RGB-lamp:";
Blockly.Msg.TEXT_SPRINTF_CONDITIONER = "Conditioner:";
Blockly.Msg.TEXT_SPRINTF_HEATING = "Valve-heating:";
Blockly.Msg.TEXT_SPRINTF_TYPE = "Type:";
...
Blockly.Msg.LT_SIMPLE_EVENT_ON_DEVICE = "Auto Off %2 time delay %3 %4On %1";
Blockly.Msg.TEXT_SPRINTF_DEV = "Device:";
Blockly.Msg.TEXT_SPRINTF_TYPE_ONOFF = "On/Off";
Blockly.Msg.TEXT_SPRINTF_TYPE_BRGHST = "Brightness in %";
Blockly.Msg.TEXT_SPRINTF_TYPE_COLOR = "Color in HEX";
Blockly.Msg.TEXT_SPRINTF_TYPE_INTPRT = "Integer part";
Blockly.Msg.TEXT_SPRINTF_TYPE_FRCT = "Fractional part";
Blockly.Msg.TEXT_SPRINTF_TYPE_FLT = "Float number";
Blockly.Msg.TEXT_SPRINTF_TYPE_MODE = "Mode";
Blockly.Msg.TEXT_SPRINTF_TYPE_TEMP = "Temperature";
Blockly.Msg.TEXT_SPRINTF_TYPE_FAN = "Fan";
Blockly.Msg.TEXT_SPRINTF_TYPE_HB = "Horizontal blinds";
Blockly.Msg.TEXT_SPRINTF_TYPE_VB = "Vertical blinds";
Blockly.Msg.TEXT_SPRINTF_TYPE_SENSTEMP = "Sensors temperature";
Blockly.Msg.LT_RESET_LEAK_SENSOR = "Reset leak sensor %1 after %2 seconds";
Blockly.Msg.LT_OTHER_SENSOR = "Sensor";
Blockly.Msg.AUTOMATION_IS_ON_DSCR = "Is automation turned on %1";
Blockly.Msg.LT_OTHER_FRATIONAL_PART = "Fractional part";
Blockly.Msg.AUTOMATION_IS_DEF_DSCR = "Is defined %1";
...
Blockly.Msg.LT_NOTIFICATION_TEXTBOX = "On %1 send message %2";
Blockly.Msg.CONDITIONER_MODE_FAN = "Fan mode";
Blockly.Msg.CONDITIONER_MODE_COOL = "Cool mode";
Blockly.Msg.CONDITIONER_MODE_DRY = "Dry mode";
Blockly.Msg.CONDITIONER_MODE_HEAT = "Heat mode";
Blockly.Msg.CONDITIONER_MODE_AUTO = "Auto mode";
Blockly.Msg.CONDITIONER_FAN_AUTO = "Auto";
Blockly.Msg.CONDITIONER_FAN_STRONG = "Strong airflow";
Blockly.Msg.CONDITIONER_FAN_EXTRA = "Extra strong airflow";
Blockly.Msg.CONDITIONER_FAN_WEAK = "Weak airflow";
Blockly.Msg.CONDITIONER_FAN_MEDIUM = "Medium airflow";
Blockly.Msg.LT_OTHER_PUSH = "Push";
Blockly.Msg.LT_OTHER_NO_MESSAGE = "No message";
Blockly.Msg.LT_OTHER_NORMAL = "Normal";
Blockly.Msg.CONDITIONER_VV_LEFT = "Extreme high";
Blockly.Msg.CONDITIONER_VV_MIDD = "High";
Blockly.Msg.CONDITIONER_VV_RIGHT = "Middle";
Blockly.Msg.CONDITIONER_VV_EXRIGHT = "Low";
Blockly.Msg.CONDITIONER_VV_LFTRGHT = "Extreme low";
Blockly.Msg.CONDITIONER_VV_EXLEFT = "Auto";
Blockly.Msg.CONDITIONER_VV_ULTR = "Ultra wide";
Blockly.Msg.LT_OTHER_INTERCOM = "Intercom";
Blockly.Msg.CONDITIONER_HV_LEFT = "Left";
Blockly.Msg.CONDITIONER_HV_MIDD = "Middle";
Blockly.Msg.CONDITIONER_HV_EXRIGHT = "Extreme right";
Blockly.Msg.CONDITIONER_HV_LFTRGHT = "Both left and right";
Blockly.Msg.CONDITIONER_HV_RIGHT = "Right airflow";
Blockly.Msg.CONDITIONER_HV_EXLEFT = "Extreme left";
Blockly.Msg.CONDITIONER_HV_ULTR = "Ultra wide";
...
Blockly.Msg.CONDITIONER_TOOLTIP = "Controls of conditioner";
Blockly.Msg.CONDITIONER_COLOR = "215"
Blockly.Msg.CONDITIONER_DSCRP = "Conditioner: %1 Act: %2";
Blockly.Msg.TEXT_CONVERTNUMB_TO_TEXT = "Number to text %1";
Blockly.Msg.TEXT_CONVERTTEXT_TO_NUMB = "Text to number %1";
Blockly.Msg.DATA_GET_TIME = "Get %1";
Blockly.Msg.DATA_TIME_SEC = "Seconds";
Blockly.Msg.DATA_TIME_MIN = "Minutes";
Blockly.Msg.DATA_TIME_HRS = "Hours";
Blockly.Msg.DATA_TIME_MSEC = "Miliseconds";
Blockly.Msg.DATA_TIME_YEAR = "Year";
Blockly.Msg.DATA_TIME_WDAY = "Weak day";
Blockly.Msg.DATA_TIME_DAY = "Day";
Blockly.Msg.DATA_TIME_MNTH = "Mounth";
Blockly.Msg.DATA_COLOUR = "215"
Blockly.Msg.DATA_MUTATOR = "Days of the week";
Blockly.Msg.DATA_MONDAY = "Monday";
Blockly.Msg.DATA_TUESDAY = "Tuesday";
Blockly.Msg.DATA_WEDNESDAY = "Wednesday";
Blockly.Msg.DATA_THURSDAY = "Thursday";
Blockly.Msg.DATA_TIMEINRANGE = "Time in range %1-%2";
Blockly.Msg.DATA_SATURDAY = "Saturday";
Blockly.Msg.DATA_FRIDAY = "Friday";
Blockly.Msg.DATA_SUNDAY = "Sunday";
Blockly.Msg.DATA_WEEKDAY = "Week day:";
...
Blockly.Msg.LT_HEATING_ACTION = "Action:";
...
Blockly.Msg.LT_DIMER_MESSAGE = "Dimer: %1 State: %2";
Blockly.Msg.LT_HEATING_MESSAGE = "Heating: %1 Temperature: %2";
Blockly.Msg.LT_OTHER_GET = "Get";
Blockly.Msg.LT_OTHER_BYTE = "Byte";
Blockly.Msg.OTHER_TEMTERATURA = "Temperatura";
...
Blockly.Msg.LT_OTHER_MODBUS = "ModBus: %1 Send to: %2 Comand: %3 Addr: %4";
...
Blockly.Msg.LT_OTHER_WEATHER = "Weather:";
