...
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_ONOFF"] = "Ввімк/Вимк";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_BRGHST"] = "Яскравість в %";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_COLOR"] = "Колір в HEX";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_INTPRT"] = "Ціла частина";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_FRCT"] = "Дробова частина";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_FLT"] = "Число з плаваючою крапкою";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_MODE"] = "Режим";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_TEMP"] = "Температура";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_POWER"] = "Потужність";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_FAN"] = "Обдув";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_HB"] = "Горизонтальний напрям";
Blockly.Msg["LT_TEXT_SPRINTF_TYPE_VB"] = "Вертикальний напрям";
